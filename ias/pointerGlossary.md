...
|Dereferencing | - | Using the `*` operator, retrieve value in the memory location pointed to by the pointer variable; when used on the LHS of an assignment statement | `*pA = 400;` | 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzkxODk3NTddfQ==
-->